...
export const COMPANY_CRO: TableColumn[] = [
  ...
  { name: 'Naziv tvrtke', prop: 'name', width: 500 },
  { name: 'Korisnici', prop: 'userCount', width: 200 },
...
export const COMPANY_ENG: TableColumn[] = [
  { name: '#', prop: 'id', width: 50 },
  { name: 'Company name', prop: 'name', width: 500 },
  { name: 'Users', prop: 'userCount', width: 200 },
  { name: 'Devices', prop: 'deviceCount', width: 150 },
